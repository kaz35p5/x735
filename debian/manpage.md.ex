...
x735 - program to do something

# SYNOPSIS

**x735** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**x735** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **x735** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**x735** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    x735. See **foo.conf**(5) for further details.
...
**x735** provides some return codes, that can be used in scripts:
...
Kaz35p5 <kaz35p5@gmail.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Kaz35p5
